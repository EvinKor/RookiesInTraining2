<%@ Page Title="Edit Level - Admin"
    Language="C#"
    MasterPageFile="~/MasterPages/dashboard.Master"
    AutoEventWireup="true"
    CodeBehind="edit_level.aspx.cs"
    Inherits="RookiesInTraining2.Pages.admin.edit_level" %>
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="mb-2"><i class="bi bi-pencil me-2 text-primary"></i>Edit Learning Level</h2>
                        <p class="mb-0 text-muted">Modify level details for <strong id="className"></strong></p>
                    </div>
