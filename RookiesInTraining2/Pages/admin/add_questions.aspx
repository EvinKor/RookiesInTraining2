<%@ Page Title="Add Questions"
    ...
    Inherits="RookiesInTraining2.Pages.admin.add_questions" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        // Override editQuestion function for admin to use teacher's edit_question page
        window.editQuestion = function (questionSlug) {
            ...
            const classSlug = '<%= Request.QueryString["class"] %>';
            const baseUrl = '<%= ResolveUrl("~/Pages/teacher/edit_question.aspx") %>';
            const url = `${baseUrl}?question=${encodeURIComponent(questionSlug)}&quiz=${encodeURIComponent(quizSlug)}&class=${encodeURIComponent(classSlug)}`;
