...
{
    public partial class create_lobby : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            System.Diagnostics.Debug.WriteLine("[CreateLobby] Page loaded");
            System.Diagnostics.Debug.WriteLine($"[CreateLobby] User: {Session["user_slug"]}");
        }
        ...
        {
            return Session["role"]?.ToString() ?? Session["Role"]?.ToString() ?? "";
        }
    }
}
