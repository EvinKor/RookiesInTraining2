...
namespace RookiesInTraining2.Pages.game
{
    public partial class game_play : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            System.Diagnostics.Debug.WriteLine("[GamePlay] Page loaded");
            System.Diagnostics.Debug.WriteLine($"[GamePlay] User: {Session["user_slug"]}");
            System.Diagnostics.Debug.WriteLine($"[GamePlay] Lobby ID: {lobbyId}");
        }
