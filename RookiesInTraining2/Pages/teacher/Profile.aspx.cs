...
namespace RookiesInTraining2.Pages
{
    public partial class TeacherProfile : System.Web.UI.Page
    {
        ...
        {
            // Check authentication - only teacher can access
        ...
        private void LoadProfileInfo()
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"[TeacherProfile] Error loading profile: {ex.Message}");
        ...
        protected void btnUpdateProfile_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                lblProfileError.Visible = true;
                lblProfileSuccess.Visible = false;
                System.Diagnostics.Debug.WriteLine($"[TeacherProfile] Error updating profile: {ex.Message}");
            }
        }
        ...
        protected void btnChangePassword_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                lblPasswordError.Visible = true;
                lblPasswordSuccess.Visible = false;
                System.Diagnostics.Debug.WriteLine($"[TeacherProfile] Error changing password: {ex.Message}");
            }
        }
