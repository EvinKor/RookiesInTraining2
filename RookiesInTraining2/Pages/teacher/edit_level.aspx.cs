    ...
    public partial class edit_level : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                lnkCancel.NavigateUrl = $"~/Pages/teacher/manage_classes.aspx?class={classSlug}&tab=storymode";
                    ...
                    using (var cmd = con.CreateCommand())
                    {
                        ...
                        using (var reader = cmd.ExecuteReader())
                        {
                            if (reader.Read())
                            {
                                ...
                                txtMinutes.Text = reader["estimated_minutes"].ToString();
                                txtXP.Text = reader["xp_reward"].ToString();
                            ...
                            {
                                Response.Redirect($"~/Pages/teacher/manage_classes.aspx?class={hfClassSlug.Value}&tab=storymode", false);
                            }
                        }
                    }
                }
