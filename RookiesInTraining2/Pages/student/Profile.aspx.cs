...
namespace RookiesInTraining2.Pages
{
    public partial class StudentProfile : System.Web.UI.Page
    {
        ...
        {
            // Check authentication - only student can access
            if (Session["UserSlug"] == null || Session["Role"]?.ToString() != "student")
            {
        ...
        private void LoadProfileInfo()
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"[StudentProfile] Error loading profile: {ex.Message}");
        ...
        protected void btnUpdateProfile_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                lblProfileError.Visible = true;
                lblProfileSuccess.Visible = false;
                System.Diagnostics.Debug.WriteLine($"[StudentProfile] Error updating profile: {ex.Message}");
            }
        }
        ...
        protected void btnChangePassword_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                lblPasswordError.Visible = true;
                lblPasswordSuccess.Visible = false;
                System.Diagnostics.Debug.WriteLine($"[StudentProfile] Error changing password: {ex.Message}");
            }
        }
