<%@ Page Title="Forum Post - Student"
    Language="C#"
    MasterPageFile="~/MasterPages/MyMain.Master"
    AutoEventWireup="true"
    CodeBehind="view_forum_post.aspx.cs"
    Inherits="RookiesInTraining2.Pages.student.view_forum_post" %>
    ...
    <div class="container-fluid mt-4">
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        <asp:Panel ID="pnlEditDeletePost" runat="server" Visible="false">
                        ...
                        <div class="card mb-3 border-start border-primary border-4">
                            <div class="card-body">
                                <div class="d-flex align-items-start mb-2">
                                    ...
                                    <asp:Panel ID="pnlReplyActions" runat="server" CssClass="flex-shrink-0">
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body p-4">
                ...
                <asp:HiddenField ID="hfPostUserSlug" runat="server" />
